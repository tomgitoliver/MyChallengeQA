#language EN
#Sample Task 2: Automation Testing -  Selenium automation & Google Chrome Browser.
@tag
Feature: Consult a product in the Homepage of Mercedes-Benz with Google Chrome Browser.
