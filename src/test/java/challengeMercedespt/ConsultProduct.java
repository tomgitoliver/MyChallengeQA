...
public class ConsultProduct {
	...
	public void i_visit_the_homepage_of_Mercedes_Benz() throws Throwable {
	    // I open the Shopping Homepage of Mercedes-Benz with the Firefox Browser.
		driver.get(url);
		System.out.println("Step 1 - open the Homepage of Mercedes-Benz with the Firefox Browser.");
		//Thread.sleep(5000);
	}
