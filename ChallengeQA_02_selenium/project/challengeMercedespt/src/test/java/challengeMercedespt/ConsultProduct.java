...
public class ConsultProduct {
	...
	public  static void Iniciator() throws Exception {
		...
		//driver.manage().timeouts().pageLoadTimeout(4000000, TimeUnit.SECONDS);
	...
	public void i_visit_the_homepage_of_Mercedes_Benz() throws Throwable {
		...
		//WebDriverWait espera = new WebDriverWait(driver, 4000);
		//WebElement element = espera.until(ExpectedConditions.elementToBeClickable(By.cssSelector("span.header-search-open-trigger-label.ng-binding)));
